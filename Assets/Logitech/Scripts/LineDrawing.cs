...
public class LineDrawing : MonoBehaviour
{
    ...
    private void TriggerHaptics()
    {
        ...
        float middleButtonPressure = _stylusHandler.CurrentState.clusterMiddleValue * dampingFactor;
    ...
    void Update()
    {
        ...
        float analogInput = Mathf.Max(_stylusHandler.CurrentState.tipValue, _stylusHandler.CurrentState.clusterMiddleValue);
